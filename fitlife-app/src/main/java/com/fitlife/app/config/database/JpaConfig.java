...
@ComponentScan("com.fitlife.app.repository.jpa")
...
public class JpaConfig implements EnvironmentAware {
    ...
    private Properties jpaProperties() {
        ...
        extraProperties.
                ...
                setProperty(ENV_HIBERNATE_SHOW_SQL, env.getProperty(ENV_HIBERNATE_SHOW_SQL));
        extraProperties.

                setProperty(ENV_HIBERNATE_DDL_AUTO, env.getProperty(ENV_HIBERNATE_DDL_AUTO));
        extraProperties.

                setProperty(NON_CONTEXTUAL_CREATION, env.getProperty(NON_CONTEXTUAL_CREATION));
        extraProperties.

                setProperty(GENERATE_DDL, env.getProperty(GENERATE_DDL));
        ...
        if (log.
            ...
            log.
                    ...
                    debug(" hibernate.dialect @" + env.getProperty(ENV_HIBERNATE_DIALECT));
        }
        if (env.

                getProperty(ENV_HIBERNATE_DIALECT) != null) {
            extraProperties.

                    setProperty(ENV_HIBERNATE_DIALECT, env.getProperty(ENV_HIBERNATE_DIALECT));
        }
